package com.jwhh.jim.notekeeper.db;
...
import com.jwhh.jim.notekeeper.model.ModuleInfo;
import com.jwhh.jim.notekeeper.model.NoteInfo;

import java.util.ArrayList;
import java.util.List;

import static com.jwhh.jim.notekeeper.db.NoteKeeperDatabaseContract.NoteInfoEntry;
...
//            ourInstance.initializeExampleNotes();
    ...
    private static void loadNotesFromDatabase(Cursor cursor) {
        int titlePos = cursor.getColumnIndex(NoteInfoEntry.COLUMN_NOTE_TITLE);
        int textPos = cursor.getColumnIndex(NoteInfoEntry.COLUMN_NOTE_TEXT);
        ...
        while (cursor.moveToNext()) {
            ...
            String text = cursor.getString(textPos);
            String courseId = cursor.getString(courseIdPos);
            int id = cursor.getInt(idPos);

            CourseInfo course = dm.getCourse(courseId);
            NoteInfo note = new NoteInfo(id, course, title, text);
            dm.mNotes.add(note);
        }
        cursor.close();
    }
